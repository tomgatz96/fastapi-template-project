...
const DeleteDoc = ({ id, boxId, onSuccess }: DeleteDocProps) => {
  ...
  const deleteDoc = async (id: string) => {
    await DocsService.deleteDoc({ id: id })
  }

  const mutation = useMutation({
    mutationFn: deleteDoc,
    onSuccess: () => {
      showSuccessToast("The doc was deleted successfully")
      setIsOpen(false)
      onSuccess()
    },
      ...
      <DialogContent className="sm:max-w-md">
        <form onSubmit={handleSubmit(onSubmit)}>
          <DialogHeader>
            ...
            <DialogDescription>
              This doc will be permanently deleted. Are you sure? You will not
